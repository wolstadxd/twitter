        ...
        <>
                <div className='header_login'>
                    <div className='header_login_wrapper'>
                        <img src="images/login_main.png" className='login_main_img' alt="login_main_img" />
                        <div className='login_dashboard'>
                            <div className='login_sign'>
                                <img src="images/twitter_logo.png" className='login_dashboard_logo' alt="" />
                                ...
                                <div className='login_privacy'>
                                    By singing up you agree to the <a target='_blank' rel="noreferrer" href="https://www.instagram.com/"><span>Terms of Service</span></a> and <a target='_blank' rel="noreferrer" href="https://www.instagram.com/"><span>Privacy Policy</span></a>, including <a target='_blank' rel="noreferrer" href="https://www.instagram.com/"><span>Cookie Use</span></a>.
                                </div>
                                <div className='login_login'>Already have an account? <a target='_blank' rel="noreferrer" href="https://www.instagram.com/"><span>Log in</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
